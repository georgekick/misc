...
#' # error checking
#' kml_pts(kml.name="temp4", spdf=spdf, type="CAS", col=c("white", "yellow"), name.col="CASE_NO")
#' # works
#' kml_pts(kml.name="temp5", spdf=spdf, type="CAS", name.col="CASE_NO")
#' kml_pts(kml.name="temp6", spdf=spdf, out.dir="temp", type="CAS", name.seq=TRUE)
#' }
kml_pts <- function(kml.name, icon.url, out.dir, spdf, type, col, name.col, name.seq=FALSE){
  # browser()
